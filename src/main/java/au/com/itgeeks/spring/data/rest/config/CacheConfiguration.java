package au.com.itgeeks.spring.data.rest.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("springRestData");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("springRestData");
        ...
        config.getMapConfigs().put("au.com.itgeeks.spring.data.rest.domain.*", initializeDomainMapConfig(jHipsterProperties));
